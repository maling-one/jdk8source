...
class CharacterData01 extends CharacterData {
  ...
  // java GenerateCharacter -plane 1 -template c:/jenkins/workspace/zulu-platform-build/zulu-src.git/jdk/make/data/characterdata/CharacterData01.java.template -spec c:/jenkins/workspace/zulu-platform-build/zulu-src.git/jdk/make/data/unicodedata/UnicodeData.txt -specialcasing c:/jenkins/workspace/zulu-platform-build/zulu-src.git/jdk/make/data/unicodedata/SpecialCasing.txt -proplist c:/jenkins/workspace/zulu-platform-build/zulu-src.git/jdk/make/data/unicodedata/PropList.txt -o c:/jenkins/workspace/zulu-platform-build/release/jdk/gensrc/java/lang/CharacterData01.java -string -usecharforbyte 11 4 1
