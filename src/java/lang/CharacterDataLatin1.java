...
class CharacterDataLatin1 extends CharacterData {
  ...
  // java GenerateCharacter -template c:/jenkins/workspace/zulu-platform-build/zulu-src.git/jdk/make/data/characterdata/CharacterDataLatin1.java.template -spec c:/jenkins/workspace/zulu-platform-build/zulu-src.git/jdk/make/data/unicodedata/UnicodeData.txt -specialcasing c:/jenkins/workspace/zulu-platform-build/zulu-src.git/jdk/make/data/unicodedata/SpecialCasing.txt -proplist c:/jenkins/workspace/zulu-platform-build/zulu-src.git/jdk/make/data/unicodedata/PropList.txt -o c:/jenkins/workspace/zulu-platform-build/release/jdk/gensrc/java/lang/CharacterDataLatin1.java -string -usecharforbyte -latin1 8
